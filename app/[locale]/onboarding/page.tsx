      ...
      <div className="w-full max-w-[440px] space-y-12">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-black tracking-tighter uppercase">{t("onboarding.title")}</h1>
            <p className="text-sm font-bold text-muted-foreground leading-snug">{t("onboarding.subtitle")}</p>
          </div>
        </div>

        <form onSubmit={handleCreateWorkspace} className="space-y-8">
          <div className="space-y-2 group">
            <label className="technical-label text-[10px] text-foreground opacity-60 ml-1">{t("onboarding.label")}</label>
