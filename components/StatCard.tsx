...
export function StatCard({ title, value, subtitle, icon: Icon, trend }: StatCardProps) {
  return (
    <div className="group relative border border-border bg-card p-5 transition-all duration-150 hover:border-brand shadow-sm rounded-xl overflow-hidden">
      <div className="flex flex-col gap-4">
        ...
        <div className="space-y-1">
          <div className="flex items-baseline gap-3">
            ...
            {trend && (
              <span className={cn(
                "text-xs font-semibold px-2 py-0.5 rounded-sm uppercase tracking-widest",
