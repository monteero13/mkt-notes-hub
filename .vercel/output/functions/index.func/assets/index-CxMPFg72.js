import React__default, { useMemo, useCallback, useRef, useState, useEffect, isValidElement, cloneElement } from "react";
import { useMemoDeepCompare, usePrevious, useMount, useUpdateEffect, useWindowSize } from "@gilbarbara/hooks";
...
import { offset, shift, arrow, useFloating, autoUpdate, autoPlacement, flip } from "@floating-ui/react-dom";
...
function JoyrideLoader({ nonce, step }) {
  ...
  if (loaderComponent) {
    ...
    content = /* @__PURE__ */ React__default.createElement(CustomLoader, { step });
  } else content = /* @__PURE__ */ React__default.createElement("div", { style: {
    ...spinnerStyles,
    height,
    width,
...
function JoyrideOverlay(props) {
  ...
  }), coverPath && /* @__PURE__ */ React__default.createElement("path", {
    d: coverPath,
    fill: overlayColor,
    style: {
  ...
  }), coverPath && Object.keys(styles.spotlight).length > 0 && /* @__PURE__ */ React__default.createElement("path", {
    d: coverPath,
    fill: "none",
...
function Arrow({ arrowComponent, arrowRef, base, placement, position, size, styles }) {
  ...
  if (ArrowComponent) {
    ...
    content = /* @__PURE__ */ React__default.createElement("span", { style: { flexShrink: 0 } }, /* @__PURE__ */ React__default.createElement(ArrowComponent, {
      base,
      placement,
      size
    }));
    ...
    if (!svg) return null;
    content = /* @__PURE__ */ React__default.createElement("svg", {
      height: svg.height,
      width: svg.width,
...
function JoyrideBeacon(props) {
  ...
  if (beaconComponent) {
    ...
    content = /* @__PURE__ */ React__default.createElement(BeaconComponent, {
      continuous,
      index,
      isLastStep,
      size,
  ...
  } else content = /* @__PURE__ */ React__default.createElement("span", { style: styles.beacon }, /* @__PURE__ */ React__default.createElement("span", { style: styles.beaconOuter }), /* @__PURE__ */ React__default.createElement("span", { style: styles.beaconInner }));
...
function JoyrideDefaultTooltip(props) {
  ...
  if (buttons.includes("primary")) buttonElements.primary = /* @__PURE__ */ React__default.createElement("button", {
    "data-testid": "button-primary",
    style: styles.buttonPrimary,
    type: "button",
    ...primaryProps
  });
  if (buttons.includes("skip") && !isLastStep) buttonElements.skip = /* @__PURE__ */ React__default.createElement("button", {
    "aria-live": "off",
  ...
  if (buttons.includes("back") && index > 0) buttonElements.back = /* @__PURE__ */ React__default.createElement("button", {
    "data-testid": "button-back",
    style: styles.buttonBack,
    type: "button",
    ...backProps
  });
  buttonElements.close = buttons.includes("close") && /* @__PURE__ */ React__default.createElement(JoyrideTooltipCloseButton, {
  ...
  return /* @__PURE__ */ React__default.createElement("div", {
    ...
    ...tooltipProps,
    ...ariaProps
  }, /* @__PURE__ */ React__default.createElement("div", { style: styles.tooltipContainer }, title && /* @__PURE__ */ React__default.createElement("h4", {
    id: "joyride-tooltip-title",
    style: styles.tooltipTitle
  }, title), /* @__PURE__ */ React__default.createElement("div", {
    id: "joyride-tooltip-content",
    style: styles.tooltipContent
  }, content)), buttons.some((b) => b === "back" || b === "primary" || b === "skip") && /* @__PURE__ */ React__default.createElement("div", { style: styles.tooltipFooter }, /* @__PURE__ */ React__default.createElement("div", { style: styles.tooltipFooterSpacer }, buttonElements.skip), buttonElements.back, buttonElements.primary), buttonElements.close);
}
function Tooltip(props) {
  ...
  if (tooltipComponent) {
    ...
    component = /* @__PURE__ */ React__default.createElement(TooltipComponent, {
      ...getElementsProps(),
      continuous,
      controls,
      index,
  ...
  } else component = /* @__PURE__ */ React__default.createElement(JoyrideDefaultTooltip, {
    ...getElementsProps(),
    continuous,
    controls,
    index,
...
function JoyrideFloater(props) {
  ...
  const scrollParent2 = useMemo(() => hasCustomScrollParent(target) ? getScrollParent(target) : void 0, [target]);
  const isFixedTarget = useMemo(() => hasPosition(target), [target]);
  const boundaryOptions = useMemo(() => scrollParent2 ? {
  ...
  if (lifecycle === LIFECYCLE.TOOLTIP || lifecycle === LIFECYCLE.TOOLTIP_BEFORE) {
    ...
    content = /* @__PURE__ */ React__default.createElement("div", {
      ...
      size,
      step
    }), !isCenter && !step.floatingOptions?.hideArrow && /* @__PURE__ */ React__default.createElement(Arrow, {
  ...
  } else if (lifecycle === LIFECYCLE.BEACON || lifecycle === LIFECYCLE.BEACON_BEFORE) content = /* @__PURE__ */ React__default.createElement("div", {
  ...
  return /* @__PURE__ */ React__default.createElement(JoyridePortal, { element: portalElement }, content);
}
function JoyrideStep(props) {
  ...
  return /* @__PURE__ */ React__default.createElement(JoyrideFloater, {
...
function TourRenderer({ controls, mergedProps, state, step, store }) {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, lifecycle !== LIFECYCLE.INIT && /* @__PURE__ */ React__default.createElement(JoyrideStep, {
    ...state,
    continuous,
    controls,
    debug,
  ...
  }), /* @__PURE__ */ React__default.createElement(JoyridePortal, { element }, /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, showLoader && /* @__PURE__ */ React__default.createElement(JoyrideLoader, {
    nonce,
    step
  }), !hideOverlay && /* @__PURE__ */ React__default.createElement(JoyrideOverlay, {
    ...step,
    continuous,
    lifecycle,
...
function useJoyride(props) {
  ...
  return {
    ...
    step,
    Tour: canUseDOM() ? /* @__PURE__ */ React__default.createElement(TourRenderer, {
      controls,
      mergedProps,
      state,
      step,
...
function Joyride(props) {
  ...
  return /* @__PURE__ */ React__default.createElement(JoyrideTour, props);
}
export {
  ACTIONS,
  EVENTS,
